...
- Lightweight example outputs are bundled for two workflows:
  - `large_context/analysis_examples/`
  - `external_validation/prepared_outputs_example/`

  These help document the workflow structure without requiring every full run from scratch.
